  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      InkWell(
        onTap: () {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => Profile_Information()));
        },
        child: Container(
            height: MediaQuery.of(context).size.height * 0.30,
            width: MediaQuery.of(context).size.width * 0.85,
            ...
            child: Row(
              ...
              children: [
                ...
                SizedBox(width: 30),
                Lottie.asset('assets/images/prof.json', width: 200, height: 200)
              ],
            )),
      ),
      SizedBox(height: 20),
        ...
        child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Lottie.asset('assets/images/cv.json', width: 200, height: 200)
              ],
            )),
      ),
      SizedBox(height: 20),
