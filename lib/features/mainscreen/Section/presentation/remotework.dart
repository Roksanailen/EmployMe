...
class Remote_Work extends StatelessWidget {
  const Remote_Work(
      ...
      required this.nameremot,
      required this.salaryremote,
      required this.remoteage,
      required this.experiencesremote,
      required this.phoneremote});
      ...
      onTap: () {
        Navigator.of(context)
          ...
          return Remote_Work_Details(
            ...
            nameremot: nameremot,
            salaryremote: salaryremote,
            remoteage: remoteage,
            experiencesremote: experiencesremote,
